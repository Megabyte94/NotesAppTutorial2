...
void main() {
  group('Mock Authentication', () {
    ...
    test('Create user should delegate to login function', () async {
      final badEmailUser = provider.register(email: 'foo@bar.com', password: 'anypassword');
      expect(badEmailUser, throwsA(const TypeMatcher<UserNotFoundAuthException>()));

      final badPasswordUser = provider.register(email: 'someone@bar.com', password: 'foobar');
